            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Binimise Biometric uses cutting-edge on-device AI to verify that a person is real (liveness detection) and matches an enrolled face — all without sending a single byte to the cloud.\n\nPowered by silent face anti-spoofing (MiniFASNet) and SFace recognition models running fully offline via ONNX Runtime.',
                    style: TextStyle(
