...
///
/// Create one via [LivenessFlutter.generateFaceMetadata] and persist it
...
/// Result returned from [LivenessFlutter.startFaceMatch].
...
class FaceMetadataResult {
  ...
  /// Pass directly to [LivenessFlutter.compareFaceMetadata] or store as-is.
  final Uint8List metadata;
